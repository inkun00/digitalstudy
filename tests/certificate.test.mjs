...
test("첫 노래 선물부터 5개 등급의 모든 조건을 함께 충족할 때 승급한다", () => {
  const cases = [
    ...
    { counseled: 2, gainPerFriend: 20, songs: 1, level: 2 },
    { counseled: 4, gainPerFriend: 25, songs: 1, level: 3 },
    { counseled: 7, gainPerFriend: 30, songs: 1, level: 4 },
    { counseled: 10, gainPerFriend: 30, songs: 1, level: 5 },
  ];
  ...
  const missingSong = calculateCertificateProgress(chatsFor({ counseled: 10, gainPerFriend: 35, songs: 0 }));
  assert.equal(missingSong.issued, false);
});
