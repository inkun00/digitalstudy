...
export default function OpeningPage() {
  ...
  useEffect(() => {
    ...
    else if (openingCompleted) router.replace("/chat");
  ...
  if (status !== "ready" || !user || user.isAnonymous || openingCompleted) return <main className="cloud-loading" role="status">친구들의 이야기를 준비하고 있어요…</main>;
